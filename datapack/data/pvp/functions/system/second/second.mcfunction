...
execute as @a[scores={shield_cooltime=1}] at @s run playsound minecraft:block.note_block.bell master @a ^ ^1.65 ^0.0001

#potionのクールタイムをカウントする
execute as @a[scores={potion_cooltime=1..}] run scoreboard players remove @s potion_cooltime 1
execute as @a[scores={potion_cooltime=1}] at @s run playsound minecraft:block.note_block.bell master @a ^ ^1.65 ^0.0001
execute as @a[scores={potion_cooltime=1}] at @s run function pvp:system/heal_potion/heal_reset
