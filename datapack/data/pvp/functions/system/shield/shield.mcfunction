...
execute at @s if score @s can_shield matches 20 run playsound minecraft:block.anvil.use master @a ^ ^1.65 ^0.0001 10 0.2
...
#reset
kill @e[tag=dig,distance=0..,type=armor_stand]