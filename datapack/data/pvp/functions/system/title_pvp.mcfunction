...
execute as @s[scores={can_title=1}] at @s[scores={can_title=1}] run playsound minecraft:block.enchantment_table.use master @s ^ ^1.65 ^0.0001 1.5

#4秒後にtitle "3"
execute as @s[scores={can_title=81}] run title @s title {"text":"3","bold":true,"italic":true,"color":"gold"}
execute as @s[scores={can_title=81}] at @s[scores={can_title=81}] run playsound minecraft:block.note_block.harp master @s ^ ^1.65 ^0.0001

#5秒後にtitle "2"
execute as @s[scores={can_title=101}] run title @s title {"text":"2","bold":true,"italic":true,"color":"gold"}
execute as @s[scores={can_title=101}] at @s[scores={can_title=101}] run playsound minecraft:block.note_block.harp master @s ^ ^1.65 ^0.0001

#6秒後にtitle "1"
execute as @s[scores={can_title=121}] run title @s title {"text":"1","bold":true,"italic":true,"color":"gold"}
execute as @s[scores={can_title=121}] at @s[scores={can_title=121}] run playsound minecraft:block.note_block.harp master @s ^ ^1.65 ^0.0001

#7秒後にtitle "Start!"
execute as @s[scores={can_title=141}] run title @s title {"text":"Start!","bold":true,"italic":true,"color":"gold"}
execute as @s[scores={can_title=141}] at @a[scores={can_title=141}] run playsound minecraft:entity.player.levelup master @s ^ ^1.65 ^0.0001
