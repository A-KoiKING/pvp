...
# ダメージ
    execute if score @s bow.count matches 1.. at @s positioned ~0 ~-0.8 ~0 run function pvp:system/bow/damage/damage

# 壁の衝突判定
    execute unless block ^ ^ ^0.5 #pvp:no_wall run function pvp:system/bow/conflict
