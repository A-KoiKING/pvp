...
# ダメージ
    ...
    execute if score @s bow.count matches 1.. at @s positioned ~0 ~-0.8 ~0 if entity @e[type=!minecraft:armor_stand,type=!minecraft:player,distance=..1,limit=1,sort=nearest,tag=!using_bow_player] as @a[tag=using_bow_player,limit=1] run scoreboard players add @s BowDamage 40
